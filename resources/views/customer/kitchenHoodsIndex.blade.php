...
<style>
    ...
    .rta-kitchen-cabinets-wrapper .line { position: relative;width: calc(17% - 1.5vw);margin: .75vw;padding: 0 20px 16px 20px;border: 4px solid #E3E3E3;border-radius: 12px;overflow: hidden;}
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active">RtaKitchenHoods</li>
                        </ul>
                    </div>
                </div>
            </div>
            <h1 class="text-center" style="margin: 20px;">Kitchen Hoods</h1>
                            ...
                            <div class="row d-flex justify-content-center">
                                    <div class="lines rta-kitchen-cabinets-wrapper d-flex justify-content-center"> 
                                        ...
                                        @foreach($kitchenHoods as $row)
                                                ...
                                                <a class="img-wrapper" href="{{ route('productDetails', $row->pscSlug) }}">
                                                    <span>
                                                        <img src="{{ asset('uploads/productSubCategory/'.$row->pscImage) }}"
                                                             alt="{{ $row->pscImage }}" style="width: 95%;margin-top: -40px;">
                                                    </span>
                                            ...
                                            @if($row->pscCategoryId == 1)
                                                <a class="button shop" href="{{ route('productDetails', $row->pscSlug ) }}">Shop Hoods</a>
                                            @elseif($row->pscCategoryId == 2)
                                                <a class="button shop" href="{{ route('productDetails', $row->pscSlug ) }}">Shop Vanities</a>
                                            @endif
