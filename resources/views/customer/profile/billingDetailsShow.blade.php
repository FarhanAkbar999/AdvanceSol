                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="border-gray-200" scope="col">Unit Price</th>
                            <th class="border-gray-200" scope="col">Quantity</th>
                            <th class="border-gray-200" scope="col">SubTotal</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($orderItems as $order)
                        <tr>
                            <!-- <td class="text-center">
                            	<img src="{{ asset('uploads/products/'.$order->image) }}" alt="{{$order->image}}" width="50px" height="50px">
                            </td> -->
                            <td> {{ $order->name }}</td>
                            <td> {{ $order->unit_price }}</td>
                            <td> {{ $order->qty }}</td>
                            <td>
                            	<span class="badge bg-light text-dark">${{ $order->subtotal_price }}</span>
                            </td>
                        </tr>
                    @endforeach
                    	...
                    	<tr>
                            ...
                            <th class="border-gray-200" scope="col"><!-- Product Name --></th>
                            <th class="border-gray-200" scope="col"><!-- Unit Price --></th>
                            <th class="border-gray-200" scope="col">Grand Total</th>
                            <th class="border-gray-200" scope="col">${{ $orders->order_total }}</th>
                        </tr>
