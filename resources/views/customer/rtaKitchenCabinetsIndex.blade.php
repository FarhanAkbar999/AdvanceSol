...
<!-- new frontend design start-->
    ...
    <!-- Header Area End Here -->
            ...
            <h1 class="text-center" style="margin: 20px;">RTA Kitchen Cabinets</h1>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-9 order-1 order-lg-2">
                            <div class="row" id="kitchenPageAfterFilter">

                                    <div class="col-lg-12">
                                        @foreach($distributer_pluck as $distributer_id)
                                            @foreach($distributers as $distributer)
                                                @if($distributer->id == $distributer_id)
                                                    <?php 
                                                        ...
                                                        ->where('product_sub_categories.distributer_id', $distributer_id)
                                                        ->get();

                                                        $distributer_subcategories_count = DB::table('product_sub_categories')
                                                        ->join('product_categories', 'product_sub_categories.pscCategoryId', '=', 'product_categories.id')
                                                        ->where('product_categories.name', 'kitchen')
                                                        ->where('product_sub_categories.distributer_id',
                                                            $distributer_id)
                                                        ->pluck('product_sub_categories.distributer_id');
                                                    ?>
                                                    <div class="text-center  col-lg-12 font-weight-bold" style="background-color:#185A73; color:white; font-size: x-large;">{{ $distributer->distributer_name }} ({{$distributer_subcategories_count->count()}} Products)</div> 
                                    </div>
                    ...
                    <!-- FormFilter AJAX start -->
                        <form action="{{ route('post.kitchen.filter') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="sidebar-categores-box">
                                            <li class="has-sub categori-checkbox" style="font-size:17px">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><input type="radio" name="frame" value="2"> Frameless</li>
                                                </ul>
                                            </li>
                                        </div>
                                    </ul>
